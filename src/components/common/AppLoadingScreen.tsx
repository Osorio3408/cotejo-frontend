  ...
  return (
    <div className="min-h-dvh bg-main-bg app-text">
      <div className="mx-auto flex min-h-dvh max-w-7xl items-center justify-center px-4">
        <div className="app-surface relative w-full max-w-xl overflow-hidden rounded-[2rem] border px-8 py-12 text-center shadow-2xl shadow-black/10">
          ...
          <div className="relative space-y-6">
            ...
            <div className="space-y-3">
              <h1 className="text-3xl font-semibold app-heading">
                Cargando tu siguiente jugada
              </h1>
              <p className="mx-auto max-w-md text-sm leading-6 app-muted">
